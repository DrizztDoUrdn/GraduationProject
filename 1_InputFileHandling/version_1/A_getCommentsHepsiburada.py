...
csv_file_dir = '../../Data/Hepsiburada/1_RawData/version_1/csv_file/'
output_dir = os.path.join(csv_file_dir, '..', 'seventh_column_extracted')
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("yorumlar.csv"):
        ...
        output_file_path = os.path.join(output_dir, f"seventh_column_{filename}")
