...
csv_file_dir = '../../../Data/Amazon/1_RawData/version_2/ExtractedColumns/'
output_dir = '../../../Data/Amazon/2_PreProcessedData/version_2/1_StopWordsRemoved'
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith('extracted_columns.csv'):
        ...
        emoji_file_path = '../../../Data/Amazon/1_RawData/version_2/Emojis/emojis.csv'
