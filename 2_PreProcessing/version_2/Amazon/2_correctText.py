...
def correct_text(csv_file_path, tokenizer, spell_checker, output_file_path):
    ...
    with (open(csv_file_path, 'r', encoding='utf-8') as infile,
        ...
        for row in reader:
            ...
            corrected_text = " ".join(token.strip() for token in corrected_tokens)

            new_row = row[:2] + [corrected_text]
            writer.writerow(new_row)


csv_file_dir = '../../../Data/Amazon/2_PreProcessedData/version_2/1_StopWordsRemoved'
output_dir = '../../../Data/Amazon/2_PreProcessedData/version_2/2_TextCorrected'
