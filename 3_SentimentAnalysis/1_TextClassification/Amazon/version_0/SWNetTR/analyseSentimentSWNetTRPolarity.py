...
csv_file_dir = '../../../../../Data/Amazon/2_PreProcessedData/version_1/3_lowercase'
output_dir = "../../../../../Data/Amazon/3_ClassifiedData/"

lexicon = pd.read_csv('../../../../../Dictionaries/SW/SWNetTR++.csv', sep=';', decimal=',')  # Assuming format: WORD, POLARITY
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith(".csv"):
        ...
        output_file_path = os.path.join(output_dir, f"analysed_amazon_tone.csv")  # Change the filename format
