...
csv_file_dir = "/Data/Hepsiburada/2_PreProcessedData/3_lowercase"
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("Hepsiburada.csv"):
        ...
        output_file_path = os.path.join(output_dir, f"analysed_hepsiburada_stn_main.csv")  # Change the filename format
