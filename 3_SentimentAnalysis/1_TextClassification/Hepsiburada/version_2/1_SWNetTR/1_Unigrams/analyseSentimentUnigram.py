...
output_dir = "../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/SWNetTR/unigram"

lexicon = pd.read_csv('../../../../../../Dictionaries/SW/SWNetTR++.csv', sep=';', decimal=',')
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith(".csv"):
        ...
        output_file_path = os.path.join(output_dir, f"analysed_hepsiburada_swnet_unigram.csv")
