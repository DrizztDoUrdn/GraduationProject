...
csv_file_dir = "../../../../../../Data/Hepsiburada/2_PreProcessedData/version_2/4_Trimmed"
output_dir = "../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/STN/unigram"

lexicon = pd.read_csv('../../../../../../Dictionaries/STN/STN_main_polarity.csv', sep=',', decimal='.')
...
def analyze_sentiment_and_save(input_file_path, lexicon, output_file_path):
    ...
    # Tokenize and 3_lowercase text in the third column
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith(".csv"):
        ...
        output_file_path = os.path.join(output_dir, f"analysed_hepsiburada_stn_unigram.csv")  # Change the filename format
