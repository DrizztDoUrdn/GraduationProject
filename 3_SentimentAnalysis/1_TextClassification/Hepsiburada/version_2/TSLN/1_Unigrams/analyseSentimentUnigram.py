...
output_dir = "../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/TSLN/unigram"
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith(".csv"):
        ...
        output_file_path = os.path.join(output_dir, f"analysed_hepsiburada_tsln_unigram.csv")  # Change the filename format
