...
output_file_path = '../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/TSLN/trigram/analysed_hepsiburada_tsln_trigram.csv'

lexicon = pd.read_csv('../../../../../../Dictionaries/TurkishSentiLiteralNet/Ngrams/Hepsiburada/turkish_sentiliteralnet_ngrams.csv', sep=',', decimal='.')
