...
csv_file_dir = '../../../../../Data/Amazon/3_ClassifiedData/'
output_dir = '../../../../../Data/Amazon/4_NormalizedSentiment/'  # Save in the same directory
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith(".csv"): ##Burayi duzelt
        input_file_path = os.path.join(csv_file_dir, filename)
        output_file_path = os.path.join(output_dir, f"normalized_amazon_tone.tsv")
