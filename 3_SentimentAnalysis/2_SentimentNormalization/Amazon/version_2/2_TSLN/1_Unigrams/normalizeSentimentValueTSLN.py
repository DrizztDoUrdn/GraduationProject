...
csv_file_dir = '../../../../../../Data/Amazon/3_ClassifiedData/version_2/TSLN/unigram/analysed_amazon_tsln_final_case.csv'
output_dir = '../../../../../../Data/Amazon/4_NormalizedSentiment/version_2'
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("final_case.csv"):
