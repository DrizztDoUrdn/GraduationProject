...
csv_file_dir = '../../../../../../Data/Amazon/3_ClassifiedData/version_2/SWNetTR/ngram/'
output_dir = '../../../../../../Data/Amazon/4_NormalizedSentiment/version_2/SWNetTR/ngram'
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("analysed_amazon_swnet_ngram.csv"):
        input_file_path = os.path.join(csv_file_dir, filename)
        output_file_path = os.path.join(output_dir, f"normalized_amazon_swnet_ngram.tsv")
