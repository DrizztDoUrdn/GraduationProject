...
csv_file_dir = '../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/STN/unigram/'
output_dir = '../../../../../../Data/Hepsiburada/4_NormalizedSentiment/version_2/STN/unigram'
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("analysed_hepsiburada_stn_unigram.csv"):
        input_file_path = os.path.join(csv_file_dir, filename)
        output_file_path = os.path.join(output_dir, f"normalized_hepsiburada_stn_unigram.tsv")
