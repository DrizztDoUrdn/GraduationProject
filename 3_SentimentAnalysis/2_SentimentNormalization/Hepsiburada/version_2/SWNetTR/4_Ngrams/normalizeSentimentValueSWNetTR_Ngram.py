...
csv_file_dir = '../../../../../../Data/Hepsiburada/3_ClassifiedData/version_2/SWNetTR/ngram/'
output_dir = '../../../../../../Data/Hepsiburada/4_NormalizedSentiment/version_2/SWNetTR/ngram/'
...
for filename in os.listdir(csv_file_dir):
    if filename.endswith("ngram.csv"):
        ...
        output_file_path = os.path.join(output_dir, f"normalised_hepsiburada_swnet_ngram.tsv")
