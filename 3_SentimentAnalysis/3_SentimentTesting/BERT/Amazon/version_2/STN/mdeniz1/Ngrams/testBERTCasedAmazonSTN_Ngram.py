...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Amazon/4_NormalizedSentiment/version_2/STN/ngram'
     '/normalized_amazon_hepsiburada_merged_stn_ngram.tsv')
...
wrong_predictions_df.to_csv('amazon_wrong_predictions_stn_ngram_mdeniz1.csv', index=False)
