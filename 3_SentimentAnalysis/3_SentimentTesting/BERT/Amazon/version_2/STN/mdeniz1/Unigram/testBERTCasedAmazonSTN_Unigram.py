...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Amazon/4_NormalizedSentiment/version_2/STN/unigram'
     '/normalized_amazon_stn_unigram.tsv')
...
wrong_predictions_df.to_csv('amazon_wrong_predictions_stn_unigram_mdeniz1.csv', index=False)
