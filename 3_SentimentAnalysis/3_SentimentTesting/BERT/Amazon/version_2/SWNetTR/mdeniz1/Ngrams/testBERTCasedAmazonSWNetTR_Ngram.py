...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Amazon/4_NormalizedSentiment/version_2/SWNetTR/ngram'
     '/normalized_amazon_swnet_ngram.tsv')
...
wrong_predictions_df.to_csv('amazon_wrong_predictions_swnet_ngram_mdeniz1.csv', index=False)
