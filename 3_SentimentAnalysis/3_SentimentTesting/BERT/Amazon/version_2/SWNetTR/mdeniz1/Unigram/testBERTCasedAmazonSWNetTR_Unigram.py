...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Amazon/4_NormalizedSentiment/version_2/SWNetTR/unigram'
     '/normalized_amazon_swnet_unigram.tsv')
...
wrong_predictions_df.to_csv('amazon_wrong_predictions_swnet_unigram_mdeniz1.csv', index=False)
