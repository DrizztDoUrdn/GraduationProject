...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Hepsiburada/4_NormalizedSentiment/version_2/unigram'
     '/normalized_hepsiburada_tsln_final_case.tsv')
...
wrong_predictions_df.to_csv('hepsiburada_wrong_predictions.csv', index=False)
