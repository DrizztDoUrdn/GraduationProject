...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Hepsiburada/4_NormalizedSentiment/version_2/STN/ngram'
     '/normalised_hepsiburada_stn_ngram.tsv')
...
wrong_predictions_df.to_csv('hepsiburada_wrong_predictions_stn_ngram.csv', index=False)
