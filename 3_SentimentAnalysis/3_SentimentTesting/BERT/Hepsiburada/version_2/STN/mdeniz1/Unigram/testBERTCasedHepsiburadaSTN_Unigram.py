...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/merged_stn_unigram.tsv')
...
wrong_predictions_df.to_csv('hepsiburada_wrong_predictions_stn_unigram.csv', index=False)
