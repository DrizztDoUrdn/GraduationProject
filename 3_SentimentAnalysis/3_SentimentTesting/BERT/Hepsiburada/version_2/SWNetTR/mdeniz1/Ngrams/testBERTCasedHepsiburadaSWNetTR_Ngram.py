...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Hepsiburada/4_NormalizedSentiment/version_2/SWNetTR/ngram'
     '/normalised_hepsiburada_swnet_ngram.tsv')
...
wrong_predictions_df.to_csv('hepsiburada_wrong_predictions_swnet_ngram_mdeniz1.csv', index=False)
