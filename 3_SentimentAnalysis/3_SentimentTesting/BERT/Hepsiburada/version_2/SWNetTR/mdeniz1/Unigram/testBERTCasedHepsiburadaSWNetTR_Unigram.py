...
f = ('C:/Users/deniz/PycharmProjects/pythonDeneme/Data/Hepsiburada/4_NormalizedSentiment/version_2/SWNetTR/unigram'
     '/normalized_hepsiburada_swnet_unigram.tsv')
...
wrong_predictions_df.to_csv('hepsiburada_wrong_predictions_swnet_unigram_mdeniz1.csv', index=False)
